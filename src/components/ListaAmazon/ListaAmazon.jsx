    ...
    return (
        <>
            <Table striped bordered hover>
                <thead>
                    <tr>
                        <th style={{backgroundColor: "blueviolet",}}>ID do Livro</th>
                        <th style={{backgroundColor: "skyblue",}}>Nome do Livro</th>
                        <th style={{backgroundColor: "skyblue",}}>Edição</th>
                        <th style={{backgroundColor: "skyblue",}}>Data da Venda</th>
                        <th style={{backgroundColor: "red",}}>Ação</th>
                    </tr>
                </thead>
