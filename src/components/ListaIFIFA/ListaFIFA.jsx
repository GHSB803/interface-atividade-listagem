    ...
    return (
        <>
            <Table striped bordered hover>
                <thead>
                    <tr>
                        <th style={{backgroundColor: "yellowgreen",}}>Player ID</th>
                        <th style={{backgroundColor: "skyblue",}}>Nome do Jogador</th>
                        <th style={{backgroundColor: "skyblue",}}>Pé Dominante</th>
                        <th style={{backgroundColor: "skyblue",}}>Posição</th>
                        <th style={{backgroundColor: "skyblue",}}>Overall</th>
                        <th style={{backgroundColor: "yellow",}}>Deletar</th>
                    </tr>
                </thead>
                <tbody>
