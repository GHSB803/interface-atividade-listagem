    ...
    return (
        <>
            <Table striped bordered hover>
                <thead>
                    <tr>
                        <th style={{backgroundColor: "blue",}}>ID do título</th>
                        <th style={{backgroundColor: "skyblue",}}>Tipo</th>
                        <th style={{backgroundColor: "skyblue",}}>Título</th>
                        <th style={{backgroundColor: "skyblue",}}>País</th>
                        <th style={{backgroundColor: "skyblue",}}>Ano de Lançamento</th>
                        <th style={{backgroundColor: "orange",}}>Deletar</th>
                    </tr>
                </thead>
                <tbody>
